**==adjust.spg  processed by SPAG 4.52O  at 16:41 on 22 Jul 1996
      SUBROUTINE ADJUST(Attemp, Nacc, Dr, Succ)
c     adjusts maximum displacement such that succ% of the
c     movels will be accepted
      IMPLICIT NONE
      INCLUDE 'system.inc'
      INTEGER Attemp, Nacc, attempp, naccp
      DOUBLE PRECISION dro, frac, Dr, Succ
      SAVE naccp, attempp
