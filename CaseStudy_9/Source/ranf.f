**==ranf.spg  processed by SPAG 4.52O  at 18:49 on  6 Jun 1996
      FUNCTION RANF(Idum)
c
...
C ----------------------------------------------------C
      END
**==randx.spg  processed by SPAG 4.52O  at 18:49 on  6 Jun 1996
...
c
      RETURN
      END
**==ranset.spg  processed by SPAG 4.52O  at 18:49 on  6 Jun 1996
...
c     --- initializes random number generator
      ...
      RETURN
      END
**==rstart.spg  processed by SPAG 4.52O  at 18:49 on  6 Jun 1996
...
c
      ...
      RETURN
      END
**==rcarry.spg  processed by SPAG 4.52O  at 18:49 on  6 Jun 1996
